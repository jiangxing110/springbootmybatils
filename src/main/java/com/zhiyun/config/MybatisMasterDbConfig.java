...
/**
 * @Classname MybatisMasterDbConfig
 * @Description TODO
 * @Date 2019/3/29 13:41
 * @Created by jiangxing
 */
@Configuration
@MapperScan(basePackages = {"com.zhiyun.mapper.master"}, sqlSessionTemplateRef = "masterSqlSessionTemplate")
